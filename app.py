    ...
    def live_dashboard():
        ...
        if is_market_open():
            ...
            _status_bar = (
                ...
                '<div style="display:flex;align-items:center;gap:0.3rem;background:rgba(25,160,95,0.1);padding:0.18rem 0.55rem;border-radius:8px;line-height:1;">'
            ...
            _status_bar = (
                ...
                'border-radius:14px;padding:0.45rem 0.85rem;box-shadow:0 2px 12px rgba(0,0,0,0.04);">'
                '<div style="display:flex;align-items:center;gap:0.45rem;flex-wrap:wrap;">'
                '<div style="display:flex;align-items:center;gap:0.3rem;background:rgba(93,111,101,0.08);padding:0.18rem 0.55rem;border-radius:8px;line-height:1;">'
